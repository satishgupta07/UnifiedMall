      ...
      { product.length <= 0 || product === undefined ? (
        ...
        <>
          ...
          <SmallText>
            ...
            <Typography>
              <StyledBadge /> Sign-up for Flipkart Pay Later & get free Times
            ...
            <Typography>
              <StyledBadge /> Purchase now & get 1 surprise cashback coupon in
              FutureKnow More
            </Typography>
            <Typography>
              <StyledBadge /> Flat ₹1,000 off on HDFC Bank Credit Card EMI Trxns
              on orders priced between ₹15,000 to ₹49,999 T&C
            </Typography>
          </SmallText>
          <Table>
            <TableBody>
